...
#定义变量与参数
dataRunTime="20230325_212743" # 10,000-20230324_013259 20230325_212216 100,000-20230324_015309 20230325_212246 1,000,000-20230324_015630 20230325_212743  10,000,000-20230324_025538 20230325_221712
...
def dataAnalytics(data):
    ...
    listSetDataI=len(list(set(data['i'])))
...
def ListAnalytics(f,data):
    PeriodMinimumList=[0.000001,0.00001]
    ...
    for i in PeriodMinimumList:
        ...
        lenIList=len(ilist)
        if lenIList > 0:
            f.write("<b style='background: yellow;'>Period <= "+str(i)+"d ~ "+str(i*86400)+"s, Count: "+str(lenIList)+" : "+str(ilist)+"</b><br />")
            with alive_bar(lenIList, ctrl_c=False, title=f'Appending data when Period lower than {i}') as bar:
                for k in range(0,lenIList):
    ...
    for i in PeriodMaximumList:
        ...
        lenIList=len(ilist)
        if lenIList > 0:
            f.write("<b style='background: yellow;'>Period >= "+str(i)+"d, Count: "+str(lenIList)+" : "+str(ilist)+"</b><br />")
...
def entrance():
    ...
    # del kwList,dataAllReturn,dataNSReturn,dataBHReturn,dataNakeHeStarCount
