...
*
      ...
      real*8 tb,ecc,yearsc,Rsun,tbx,CG,Mtotal
...
*
      ...
      READ(22,*)neta,bwind,hewind,alpha1,lambda,SNtype
...
*
 ...
 52   j = j + 1
      ...
      Rsun = 6.96e8
      CG= 6.67e-11
      Mtotal = 1.99e30*(bpp(j,2)+bpp(j,3))
      tbx = ((bpp(j,6)*Rsun)**3*39.476/(CG*Mtotal))**0.5/8.64e4
      WRITE(*,100)(bpp(j,k),k=1,3),kstar,tbx,(bpp(j,k),k=7,9),label(kw)
      goto 52
 60   continue
